...
const MOCK_POSTS: Record<string, BlogPost> = {
	"scrum-ceremonies-guide": {
		...
		excerpt:
			"Learn how to make the most of your Sprint Planning, Daily Standups, and Retrospectives.",
		content: `
...
- Action items for the next sprint
	...
	"scrum-ceremonies-guide2": {
		id: "2",
		slug: "scrum-ceremonies-guide2",
		title: "The Complete Guide to SCRUM Ceremonies",
		excerpt:
			"Learn how to make the most of your Sprint Planning, Daily Standups, and Retrospectives.",
		content: `
...
export async function getRelatedPosts(slug: string): Promise<RelatedPost[]> {
	...
	return [
		...
		},
		{
			...
			excerpt:
				"Learn how to maintain a healthy and prioritized product backlog.",
			featuredImage:
